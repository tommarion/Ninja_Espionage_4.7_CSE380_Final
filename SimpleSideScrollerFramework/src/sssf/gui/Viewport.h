...
public:
	...
	void setXPass(bool val)		{ xPass = val; }
	void setYPass(bool val)		{ yPass = val; }
	...
	void moveViewport(int incX, int incY,	int worldWidth, int worldHeight, int ppX, int ppY, int vX, int vY, wstring state);
