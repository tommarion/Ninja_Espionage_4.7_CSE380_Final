...
/*
	...
	in the game.
*/
void Physics::removeCollidableObjectBot(CollidableObject *collidableObjectToRemove)
{
	map<CollidableObject*, set<Tile*>>::iterator tileSetToRemoveIt = spriteToTileCollisionsThisFrame.find(collidableObjectToRemove);
	map<CollidableObject*, set<Tile*>>::iterator end = spriteToTileCollisionsThisFrame.end();
	if (tileSetToRemoveIt != end)
...
void Physics::clearCollidableObjects()
{
	spriteToTileCollisionsThisFrame.clear();
	//sortedSweptShapes.clear();
}
