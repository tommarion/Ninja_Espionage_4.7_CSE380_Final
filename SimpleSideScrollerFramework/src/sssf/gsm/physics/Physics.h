...
public:
	...
	void removeCollidableObjectBot(CollidableObject *collidableObjectToRemove);
	void togglePhysics() { activated = !activated; }
	void update(Game *game);
	bool willSpriteCollideOnTile(CollidableObject *co, AABB *tileAABB);
	void clearCollidableObjects(); //added by me but not working //added by me but not working 
