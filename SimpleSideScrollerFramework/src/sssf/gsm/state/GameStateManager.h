...
static const LPCWSTR	LPCW_PLAY_SPLASH = L"play sounds/BG_SPLASH.mp3 repeat";
static const LPCWSTR	LPCW_STOP_SPLASH = L"stop sounds/BG_SPLASH.mp3";
static const LPCWSTR	LPCW_PLAY_GAME = L"play sounds/BG_GAMEPLAY.mp3 repeat";
static const LPCWSTR	LPCW_STOP_GAME = L"stop sounds/BG_GAMEPLAY.mp3";
class Game;
...
public:
	...
	void			goToLoadLevel();
	void			goToMainMenu();
	void			goToGameWon(Game *game);
	void			goToGameLost(Game *game);
	void			goToGameFail(Game *game);
